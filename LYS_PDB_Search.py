...
def Download_selected_PDB_files_and_add_resolution_and_percentage_id(initial_dataframe):
    ...
    indexes = max_vals.index.levels[1]
    ungrouped_dataframe=ungrouped_dataframe.ix[indexes] #Get only the rows where the percentid and coverage are maximum
    ...
    filtered_dataframe = ungrouped_dataframe.ix[min_indexes]  # Get only the rows where the percentid and coverage are maximum
